...
@RequiresApi(Build.VERSION_CODES.PUMPKIN_CAKE)
class PmsHookTarget35(private val service: HMAService) : IFrameworkHook {

    companion object {
        private const val TAG = "PmsHookTarget35"
    }
